...
type
PointerMenuItemIterateFunction = function(MenuItem: TMenuItem): Boolean; // range fix
...
var
  ...
  function Iterate(var I: Integer; MenuItem: TElMenuItem; AFunc: PointerMenuItemIterateFunction): Boolean;   // range fix
  var
    Item: TMenuItem;
  begin

...
private:
	...
	typedef xr_map< LPCSTR,CObjectInfo* > CLASS_INFO_MAP; typedef CLASS_INFO_MAP::iterator CLASS_INFO_MAP_IT;
	typedef xr_map< CObject*,CLASS_INFO_MAP > OBJECT_INFO_MAP; typedef OBJECT_INFO_MAP::iterator OBJECT_INFO_MAP_IT;
	typedef xr_map< SKey,CTextInfo* > TEXT_INFO_MAP; typedef TEXT_INFO_MAP::iterator TEXT_INFO_MAP_IT;
	typedef xr_map< SKey,CLevelInfo* > LEVEL_INFO_MAP; typedef LEVEL_INFO_MAP::iterator LEVEL_INFO_MAP_IT;

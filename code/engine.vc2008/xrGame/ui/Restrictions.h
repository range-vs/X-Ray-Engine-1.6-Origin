...
private:	
	...
	typedef xr_vector< shared_str > group_items; typedef group_items::iterator group_items_it;
	typedef xr_map< shared_str, group_items > Groups; typedef Groups::iterator Groups_it;
	Groups											m_goups;


	typedef		std::pair<shared_str, u32>			restr_item;
	typedef xr_vector< restr_item > rank_rest_vec; typedef rank_rest_vec::iterator rank_rest_vec_it;

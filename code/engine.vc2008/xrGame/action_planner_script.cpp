...
{
//	module(L)[class_<CScriptActionPlanner, no_bases, default_holder, CScriptActionPlannerWrapper>("action_planner")
...
//	];
    module(
        L)[class_<CScriptActionPlanner, no_bases, default_holder, CScriptActionPlannerWrapper>("action_planner")
        .def_readonly("object", &CScriptActionPlanner::m_object)
        .def_readonly("storage", &CScriptActionPlanner::m_storage)
        .def(constructor<>())
        .def("actual", &get_actual)
        ...
        .def("action", &CScriptActionPlanner::action)
        .def("add_evaluator",
            &CScriptActionPlanner::add_evaluator, adopt<3>())

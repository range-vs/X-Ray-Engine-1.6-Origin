...
typedef xr_vector< shared_str > ARTICLE_ID_VECTOR; typedef ARTICLE_ID_VECTOR::iterator ARTICLE_ID_IT;
typedef xr_vector< ARTICLE_DATA > ARTICLE_VECTOR; typedef ARTICLE_VECTOR::iterator ARTICLE_IT;

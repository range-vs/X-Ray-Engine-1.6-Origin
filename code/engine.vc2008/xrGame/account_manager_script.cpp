...
void account_manager::script_register	(lua_State *L)
{
	...
	[
		class_<account_manager>("account_manager")
			...
			.def("get_suggested_unicks",	&account_manager::get_suggested_unicks, luabind::policy::return_stl_iterator())
			...
			.def("get_found_profiles",		&account_manager::get_found_profiles, luabind::policy::return_stl_iterator())

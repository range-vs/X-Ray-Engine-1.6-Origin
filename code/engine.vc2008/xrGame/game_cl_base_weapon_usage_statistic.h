...
typedef xr_vector< BulletData > ABULLETS; typedef ABULLETS::iterator ABULLETS_it;
...
typedef xr_vector< HitData > HITS_VEC; typedef HITS_VEC::iterator HITS_VEC_it;
...
typedef xr_vector< Weapon_Statistic > WEAPON_STATS; typedef WEAPON_STATS::iterator WEAPON_STATS_it;
...
typedef xr_vector< Player_Statistic > PLAYERS_STATS; typedef PLAYERS_STATS::iterator PLAYERS_STATS_it;
...
typedef xr_vector< Bullet_Check_Request > BChR; typedef BChR::iterator BChR_it;
...
typedef xr_vector< Bullet_Check_Array > BChA; typedef BChA::iterator BChA_it;

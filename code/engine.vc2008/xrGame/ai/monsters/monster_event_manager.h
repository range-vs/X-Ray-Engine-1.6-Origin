...
class CMonsterEventManager {
	...
	typedef xr_vector< event_struc > EVENT_VECTOR; typedef EVENT_VECTOR::iterator EVENT_VECTOR_IT;
	typedef xr_map< EEventType,EVENT_VECTOR > EVENT_MAP; typedef EVENT_MAP::iterator EVENT_MAP_IT;

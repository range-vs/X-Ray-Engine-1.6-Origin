...
class CControlAnimation : public CControl_ComPure<SControlAnimationData> {
	...
	typedef xr_vector< SAnimationEvent > ANIMATION_EVENT_VEC; typedef ANIMATION_EVENT_VEC::iterator ANIMATION_EVENT_VEC_IT;
	typedef xr_map< MotionID,ANIMATION_EVENT_VEC > ANIMATION_EVENT_MAP; typedef ANIMATION_EVENT_MAP::iterator ANIMATION_EVENT_MAP_IT;

...
class CControl_Manager {
	...
	typedef xr_vector< CControl_Com* > CONTROLLERS_VECTOR; typedef CONTROLLERS_VECTOR::iterator CONTROLLERS_VECTOR_IT;
	typedef xr_map< ControlCom::EEventType,CONTROLLERS_VECTOR > LISTENERS_MAP; typedef LISTENERS_MAP::iterator LISTENERS_MAP_IT;
	LISTENERS_MAP			m_listeners;

	// contains all available controllers
	typedef xr_map< ControlCom::EControlType,CControl_Com* > CONTROLLERS_MAP; typedef CONTROLLERS_MAP::iterator CONTROLLERS_MAP_IT;
	CONTROLLERS_MAP			m_control_elems;
	CONTROLLERS_MAP			m_base_elems;
	
	typedef xr_vector< CControl_Com* > COM_VEC; typedef COM_VEC::iterator COM_VEC_IT;

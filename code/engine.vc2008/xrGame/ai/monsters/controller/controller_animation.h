...
private:
	...
	typedef xr_map< ELegsActionType,MotionID > LEGS_MOTION_MAP; typedef LEGS_MOTION_MAP::iterator LEGS_MOTION_MAP_IT;
	typedef xr_map< ETorsoActionType,MotionID > TORSO_MOTION_MAP; typedef TORSO_MOTION_MAP::iterator TORSO_MOTION_MAP_IT;
	...
	typedef xr_vector< SPathRotations > PATH_ROTATIONS_VEC; typedef PATH_ROTATIONS_VEC::iterator PATH_ROTATIONS_VEC_IT;
	typedef xr_map< ELegsActionType,PATH_ROTATIONS_VEC > PATH_ROTATIONS_MAP; typedef PATH_ROTATIONS_MAP::iterator PATH_ROTATIONS_MAP_IT;

...
class change_loophole :	
	public action_base
	//,private debug::make_final<change_loophole> // range fix
{
private:
...
class non_animated_change_loophole:
	public action_base
	//,private debug::make_final<non_animated_change_loophole> // range fix
{
private:
	typedef action_base								inherited;
...
class exit :
	public action_base
	//,private debug::make_final<exit> // range fix
{
private:
	typedef action_base								inherited;

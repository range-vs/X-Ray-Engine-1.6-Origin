...
struct CDataStorageBinaryHeap {
	...
	>
	class CDataStorage : public _data_storage::template CDataStorage<_vertex> // range fix template
	{
	public:
		typedef typename _data_storage::template CDataStorage<_vertex>	inherited; // range fix template

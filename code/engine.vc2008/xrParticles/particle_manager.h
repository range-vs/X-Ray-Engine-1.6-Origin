...
namespace PAPI{
    class CParticleManager: public IParticleManager
    {
		...
		typedef xr_vector< ParticleEffect* > ParticleEffectVec; typedef ParticleEffectVec::iterator ParticleEffectVecIt;
		typedef xr_vector< ParticleActions* > ParticleActionsVec; typedef ParticleActionsVec::iterator ParticleActionsVecIt;

...
typedef xr_vector< u32 > DWORDs; typedef DWORDs::iterator DWORDs_it;
//struct NodeMerged
//{
...
typedef xr_vector< vertex > Nodes; typedef Nodes::iterator Nodes_it;
//DEF_VECTOR(Merged,NodeMerged	);
typedef xr_vector< Fvector > Vectors; typedef Vectors::iterator Vectors_it;
typedef xr_vector< BYTE > Marks; typedef Marks::iterator Marks_it;
typedef xr_vector< R_Light > Lights; typedef Lights::iterator Lights_it;

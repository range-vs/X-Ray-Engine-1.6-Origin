...
typedef xr_map< u32,::CLevelGameGraph* > GRAPH_P_MAP; typedef GRAPH_P_MAP::iterator GRAPH_P_PAIR_IT;
typedef xr_map< LPSTR,SConnectionVertex, CCompareVertexPredicate > VERTEX_MAP; typedef VERTEX_MAP::iterator VERTEX_PAIR_IT;
...
typedef xr_vector< SDynamicGraphVertex > GRAPH_VERTEX_VECTOR; typedef GRAPH_VERTEX_VECTOR::iterator GRAPH_VERTEX_IT;
typedef xr_vector< CGameGraph::CEdge > GRAPH_EDGE_VECTOR; typedef GRAPH_EDGE_VECTOR::iterator GRAPH_EDGE_IT;

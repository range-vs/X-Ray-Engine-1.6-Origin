...
typedef xr_vector< SOGFVert > OGFVertVec; typedef OGFVertVec::iterator OGFVertIt;
typedef xr_vector< SOGFFace > OGFFaceVec; typedef OGFFaceVec::iterator OGFFaceIt;
...
//----------------------------------------------------
typedef xr_vector< CObjectOGFCollectorPacked* > COGFCPVec; typedef COGFCPVec::iterator COGFCPIt;
...
class ECORE_API CExportObjectOGF
{
	...
	typedef xr_vector< SSplit* > SplitVec; typedef SplitVec::iterator SplitIt;
	SplitVec			m_Splits;

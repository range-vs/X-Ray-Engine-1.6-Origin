...
public:
    struct SDebugDraw{
	    ...
	    typedef xr_vector< Face > FaceVec; typedef FaceVec::iterator FaceIt;
	    typedef xr_vector< Line > LineVec; typedef LineVec::iterator LineIt;
	    typedef xr_vector< Point > PointVec; typedef PointVec::iterator PointIt;
		typedef xr_vector< Fobb > OBBVec; typedef OBBVec::iterator OBBVecIt;
    	FaceVec			m_WireFaces;

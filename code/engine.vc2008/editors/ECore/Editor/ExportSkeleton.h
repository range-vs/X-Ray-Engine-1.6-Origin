...
typedef xr_vector< SSkelVert > SkelVertVec; typedef SkelVertVec::iterator SkelVertIt;
typedef xr_vector< SSkelFace > SkelFaceVec; typedef SkelFaceVec::iterator SkelFaceIt;

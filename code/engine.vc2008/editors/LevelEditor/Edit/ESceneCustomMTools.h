...
typedef xr_vector< TUI_CustomControl* > ControlsVec; typedef ControlsVec::iterator ControlsIt;
...
typedef xr_map< ObjClassID,ESceneToolBase* > SceneToolsMap; typedef SceneToolsMap::iterator SceneToolsMapPairIt;

...
protected:
    ...
    // class 
    typedef xr_vector< SChooseItem > SSVec; typedef SSVec::iterator SSVecIt;
    typedef xr_map< CLASS_ID,SSVec > ClassSpawnMap; typedef ClassSpawnMap::iterator ClassSpawnMapIt;
    ClassSpawnMap		m_Classes;

    // icon list
    typedef xr_map< shared_str,ref_shader > ShaderMap; typedef ShaderMap::iterator ShaderPairIt;
    ShaderMap 			m_Icons;

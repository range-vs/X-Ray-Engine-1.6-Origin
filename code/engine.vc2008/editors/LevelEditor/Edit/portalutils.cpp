...
class sCollector
{
    ...
    typedef xr_vector< sVert > sVertVec; typedef sVertVec::iterator sVertIt;
    typedef xr_vector< sFace > sFaceVec; typedef sFaceVec::iterator sFaceIt;
    typedef xr_vector< sEdge > sEdgeVec; typedef sEdgeVec::iterator sEdgeIt;
    typedef xr_vector< sPortal > sPortalVec; typedef sPortalVec::iterator sPortalIt;
public:
    sVertVec		verts;
    sFaceVec		faces;
    sEdgeVec		edges;

...
struct 	SBFace;
class 	CSurface;
typedef xr_vector< SBFace* > SBFaceVec; typedef SBFaceVec::iterator SBFaceVecIt;
...
typedef xr_vector< SBBone > SBBoneVec; typedef SBBoneVec::iterator SBBoneVecIt;
typedef xr_vector< SBFaceVec > SBAdjVec; typedef SBAdjVec::iterator SBAdjVecIt;
...
typedef xr_vector< SBPart* > SBPartVec; typedef SBPartVec::iterator SBPartVecIt;
//----------------------------------------------------

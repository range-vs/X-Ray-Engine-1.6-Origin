...
typedef svector< SIndexDist,4 > SIndexDistVec; typedef SIndexDistVec::iterator SIndexDistIt;

typedef xr_map< u32,DOVec > ColorIndexMap; typedef ColorIndexMap::iterator ColorIndexPairIt;

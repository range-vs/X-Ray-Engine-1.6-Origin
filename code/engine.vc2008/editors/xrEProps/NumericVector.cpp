...
bool NumericVectorRun(const char* title, Fvector* data, double inc, int decimal, Fvector* reset_value, Fvector* min, Fvector* max, int* X, int* Y){
    ...
    bool res = frmNumericVector->Run(title, data, inc, decimal, reset_value, min, max, X, Y);
...
//----------------------------------------------------
bool __fastcall TfrmNumericVector::Run(const char* title, Fvector* data, double inc, int decimal, Fvector* rv, Fvector* MN, Fvector* MX, int* X, int* Y)
{

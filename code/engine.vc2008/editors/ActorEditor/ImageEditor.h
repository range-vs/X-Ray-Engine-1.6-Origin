...
private:	// User declarations
    ...
    typedef xr_vector< ETextureThumbnail* > THMVec; typedef THMVec::iterator THMIt;
    typedef xr_map< shared_str,ETextureThumbnail* > THMMap; typedef THMMap::iterator THMMapIt;
    THMMap				m_THM_Used;

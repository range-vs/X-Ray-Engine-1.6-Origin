...
#	define FATAL_STACKTRACE(description, stack_trace)			Debug.stop(DEBUG_INFO,description, stack_trace)
#	define FATAL(description)			Debug.stop(DEBUG_INFO,description)

...
typedef std::vector< way_point_le > way_point_le_vec; typedef std::vector< way_point_le >::iterator way_point_le_vec_it; typedef std::vector< way_point_le >::const_iterator way_point_le_vec_cit;

...
protected:
	...
	typedef std::vector< path_alias* > path_alias_vec; typedef std::vector< path_alias* >::iterator path_alias_vec_it; typedef std::vector< path_alias* >::const_iterator path_alias_vec_cit;

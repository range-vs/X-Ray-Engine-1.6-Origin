...
typedef std::vector< detail_object* > detail_object_vec; typedef std::vector< detail_object* >::iterator detail_object_vec_it; typedef std::vector< detail_object* >::const_iterator detail_object_vec_cit;
...
typedef std::vector< color_index* > color_index_vec; typedef std::vector< color_index* >::iterator color_index_vec_it; typedef std::vector< color_index* >::const_iterator color_index_vec_cit;

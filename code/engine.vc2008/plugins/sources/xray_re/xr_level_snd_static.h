...
typedef std::vector< sound_src_data* > sound_src_data_vec; typedef std::vector< sound_src_data* >::iterator sound_src_data_vec_it; typedef std::vector< sound_src_data* >::const_iterator sound_src_data_vec_cit;

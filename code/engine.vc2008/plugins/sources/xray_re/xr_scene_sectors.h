...
typedef std::vector< sector_item > sector_item_vec; typedef std::vector< sector_item >::iterator sector_item_vec_it; typedef std::vector< sector_item >::const_iterator sector_item_vec_cit;

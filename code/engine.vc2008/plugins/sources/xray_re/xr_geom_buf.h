...
typedef std::vector< xr_vbuf > xr_vbuf_vec; typedef std::vector< xr_vbuf >::iterator xr_vbuf_vec_it; typedef std::vector< xr_vbuf >::const_iterator xr_vbuf_vec_cit;
...
typedef std::vector< xr_ibuf > xr_ibuf_vec; typedef std::vector< xr_ibuf >::iterator xr_ibuf_vec_it; typedef std::vector< xr_ibuf >::const_iterator xr_ibuf_vec_cit;
...
typedef std::vector< xr_swibuf > xr_swibuf_vec; typedef std::vector< xr_swibuf >::iterator xr_swibuf_vec_it; typedef std::vector< xr_swibuf >::const_iterator xr_swibuf_vec_cit;

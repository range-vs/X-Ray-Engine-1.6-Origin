...
typedef std::vector< fog_vol_data* > fog_vol_data_vec; typedef std::vector< fog_vol_data* >::iterator fog_vol_data_vec_it; typedef std::vector< fog_vol_data* >::const_iterator fog_vol_data_vec_cit;

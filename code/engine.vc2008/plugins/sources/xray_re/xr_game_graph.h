...
typedef std::vector< xr_level_gct* > xr_level_gct_vec; typedef std::vector< xr_level_gct* >::iterator xr_level_gct_vec_it; typedef std::vector< xr_level_gct* >::const_iterator xr_level_gct_vec_cit;

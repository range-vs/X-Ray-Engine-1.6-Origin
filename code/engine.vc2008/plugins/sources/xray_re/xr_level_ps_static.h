...
typedef std::vector< particle_data* > particle_data_vec; typedef std::vector< particle_data* >::iterator particle_data_vec_it; typedef std::vector< particle_data* >::const_iterator particle_data_vec_cit;

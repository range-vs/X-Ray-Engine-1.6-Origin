...
typedef std::vector< portal_data* > portal_data_vec; typedef std::vector< portal_data* >::iterator portal_data_vec_it; typedef std::vector< portal_data* >::const_iterator portal_data_vec_cit;

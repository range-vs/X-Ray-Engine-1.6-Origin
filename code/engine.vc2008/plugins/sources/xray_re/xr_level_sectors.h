...
typedef std::vector< sector_data* > sector_data_vec; typedef std::vector< sector_data* >::iterator sector_data_vec_it; typedef std::vector< sector_data* >::const_iterator sector_data_vec_cit;

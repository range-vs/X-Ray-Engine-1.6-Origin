...
typedef std::vector< way_link > way_link_vec; typedef std::vector< way_link >::iterator way_link_vec_it; typedef std::vector< way_link >::const_iterator way_link_vec_cit;
...
typedef std::vector< way_point > way_point_vec; typedef std::vector< way_point >::iterator way_point_vec_it; typedef std::vector< way_point >::const_iterator way_point_vec_cit;
...
typedef std::vector< way_path* > way_path_vec; typedef std::vector< way_path* >::iterator way_path_vec_it; typedef std::vector< way_path* >::const_iterator way_path_vec_cit;
...
typedef std::vector< mp_rpoint* > mp_rpoint_vec; typedef std::vector< mp_rpoint* >::iterator mp_rpoint_vec_it; typedef std::vector< mp_rpoint* >::const_iterator mp_rpoint_vec_cit;

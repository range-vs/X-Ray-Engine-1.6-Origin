...
typedef std::vector< xr_custom_object* > xr_custom_object_vec; typedef std::vector< xr_custom_object* >::iterator xr_custom_object_vec_it; typedef std::vector< xr_custom_object* >::const_iterator xr_custom_object_vec_cit;

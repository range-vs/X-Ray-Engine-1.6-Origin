...
private:
	...
	typedef std::vector< ini_item* > ini_item_vec; typedef std::vector< ini_item* >::iterator ini_item_vec_it; typedef std::vector< ini_item* >::const_iterator ini_item_vec_cit;
	...
	typedef std::vector< ini_section* > ini_section_vec; typedef std::vector< ini_section* >::iterator ini_section_vec_it; typedef std::vector< ini_section* >::const_iterator ini_section_vec_cit;

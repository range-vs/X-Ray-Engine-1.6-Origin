...
typedef std::vector< xr_token > xr_token_vec; typedef std::vector< xr_token >::iterator xr_token_vec_it; typedef std::vector< xr_token >::const_iterator xr_token_vec_cit;

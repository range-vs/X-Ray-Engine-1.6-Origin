...
typedef std::vector< xr_scene_part* > xr_scene_part_vec; typedef std::vector< xr_scene_part* >::iterator xr_scene_part_vec_it; typedef std::vector< xr_scene_part* >::const_iterator xr_scene_part_vec_cit;

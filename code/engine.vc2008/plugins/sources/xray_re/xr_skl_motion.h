...
typedef std::vector< xr_bone_motion* > xr_bone_motion_vec; typedef std::vector< xr_bone_motion* >::iterator xr_bone_motion_vec_it; typedef std::vector< xr_bone_motion* >::const_iterator xr_bone_motion_vec_cit;
...
typedef std::vector< xr_motion_marks* > xr_motion_marks_vec; typedef std::vector< xr_motion_marks* >::iterator xr_motion_marks_vec_it; typedef std::vector< xr_motion_marks* >::const_iterator xr_motion_marks_vec_cit;
...
typedef std::vector< xr_skl_motion* > xr_skl_motion_vec; typedef std::vector< xr_skl_motion* >::iterator xr_skl_motion_vec_it; typedef std::vector< xr_skl_motion* >::const_iterator xr_skl_motion_vec_cit;

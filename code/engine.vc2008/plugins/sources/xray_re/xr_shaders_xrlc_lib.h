...
typedef std::vector< xr_shader_xrlc* > xr_shader_xrlc_vec; typedef std::vector< xr_shader_xrlc* >::iterator xr_shader_xrlc_vec_it; typedef std::vector< xr_shader_xrlc* >::const_iterator xr_shader_xrlc_vec_cit;

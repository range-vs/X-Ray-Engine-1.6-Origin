...
public:
	...
	typedef std::vector< b_face > b_face_vec; typedef std::vector< b_face >::iterator b_face_vec_it; typedef std::vector< b_face >::const_iterator b_face_vec_cit;
	...
	typedef std::vector< b_edge > b_edge_vec; typedef std::vector< b_edge >::iterator b_edge_vec_it; typedef std::vector< b_edge >::const_iterator b_edge_vec_cit;
...
protected:
	...
	typedef std::vector< b_proxy > b_proxy_vec; typedef std::vector< b_proxy >::iterator b_proxy_vec_it; typedef std::vector< b_proxy >::const_iterator b_proxy_vec_cit;

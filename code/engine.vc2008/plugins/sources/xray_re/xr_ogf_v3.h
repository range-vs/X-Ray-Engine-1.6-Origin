...
typedef std::vector< xr_ogf_v3* > xr_ogf_v3_vec; typedef std::vector< xr_ogf_v3* >::iterator xr_ogf_v3_vec_it; typedef std::vector< xr_ogf_v3* >::const_iterator xr_ogf_v3_vec_cit;

...
typedef std::vector< glow_data* > glow_data_vec; typedef std::vector< glow_data* >::iterator glow_data_vec_it; typedef std::vector< glow_data* >::const_iterator glow_data_vec_cit;

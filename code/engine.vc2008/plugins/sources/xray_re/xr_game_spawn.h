...
typedef std::vector< way_point_gs > way_point_gs_vec; typedef std::vector< way_point_gs >::iterator way_point_gs_vec_it; typedef std::vector< way_point_gs >::const_iterator way_point_gs_vec_cit;
...
typedef std::vector< way_path_gs* > way_path_gs_vec; typedef std::vector< way_path_gs* >::iterator way_path_gs_vec_it; typedef std::vector< way_path_gs* >::const_iterator way_path_gs_vec_cit;

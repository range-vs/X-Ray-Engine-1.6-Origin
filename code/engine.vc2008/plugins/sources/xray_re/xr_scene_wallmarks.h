...
typedef std::vector< wm_object > wm_object_vec; typedef std::vector< wm_object >::iterator wm_object_vec_it; typedef std::vector< wm_object >::const_iterator wm_object_vec_cit;
...
typedef std::vector< wm_slot_le* > wm_slot_le_vec; typedef std::vector< wm_slot_le* >::iterator wm_slot_le_vec_it; typedef std::vector< wm_slot_le* >::const_iterator wm_slot_le_vec_cit;

...
typedef std::vector< xr_vmap* > xr_vmap_vec; typedef std::vector< xr_vmap* >::iterator xr_vmap_vec_it; typedef std::vector< xr_vmap* >::const_iterator xr_vmap_vec_cit;
...
typedef std::vector< xr_weight_vmap* > xr_weight_vmap_vec; typedef std::vector< xr_weight_vmap* >::iterator xr_weight_vmap_vec_it; typedef std::vector< xr_weight_vmap* >::const_iterator xr_weight_vmap_vec_cit;
...
typedef std::vector< xr_surfmap* > xr_surfmap_vec; typedef std::vector< xr_surfmap* >::iterator xr_surfmap_vec_it; typedef std::vector< xr_surfmap* >::const_iterator xr_surfmap_vec_cit;
...
typedef std::vector< lw_face > lw_face_vec; typedef std::vector< lw_face >::iterator lw_face_vec_it; typedef std::vector< lw_face >::const_iterator lw_face_vec_cit;
...
typedef std::vector< lw_vmref > lw_vmref_vec; typedef std::vector< lw_vmref >::iterator lw_vmref_vec_it; typedef std::vector< lw_vmref >::const_iterator lw_vmref_vec_cit;
...
typedef std::vector< xr_mesh* > xr_mesh_vec; typedef std::vector< xr_mesh* >::iterator xr_mesh_vec_it; typedef std::vector< xr_mesh* >::const_iterator xr_mesh_vec_cit;

...
typedef std::vector< light_data* > light_data_vec; typedef std::vector< light_data* >::iterator light_data_vec_it; typedef std::vector< light_data* >::const_iterator light_data_vec_cit;

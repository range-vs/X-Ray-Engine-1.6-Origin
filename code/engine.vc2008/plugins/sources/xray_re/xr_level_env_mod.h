...
typedef std::vector< env_mod_data* > env_mod_data_vec; typedef std::vector< env_mod_data* >::iterator env_mod_data_vec_it; typedef std::vector< env_mod_data* >::const_iterator env_mod_data_vec_cit;

...
typedef std::vector< cf_vertex > cf_vertex_vec; typedef std::vector< cf_vertex >::iterator cf_vertex_vec_it; typedef std::vector< cf_vertex >::const_iterator cf_vertex_vec_cit;
...
typedef std::vector< cf_face > cf_face_vec; typedef std::vector< cf_face >::iterator cf_face_vec_it; typedef std::vector< cf_face >::const_iterator cf_face_vec_cit;

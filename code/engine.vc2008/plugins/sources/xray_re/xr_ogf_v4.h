...
typedef std::vector< xr_ogf_v4* > xr_ogf_v4_vec; typedef std::vector< xr_ogf_v4* >::iterator xr_ogf_v4_vec_it; typedef std::vector< xr_ogf_v4* >::const_iterator xr_ogf_v4_vec_cit;

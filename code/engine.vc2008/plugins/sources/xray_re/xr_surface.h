...
typedef std::vector< xr_raw_surface > xr_raw_surface_vec; typedef std::vector< xr_raw_surface >::iterator xr_raw_surface_vec_it; typedef std::vector< xr_raw_surface >::const_iterator xr_raw_surface_vec_cit;
...
typedef std::vector< xr_surface* > xr_surface_vec; typedef std::vector< xr_surface* >::iterator xr_surface_vec_it; typedef std::vector< xr_surface* >::const_iterator xr_surface_vec_cit;

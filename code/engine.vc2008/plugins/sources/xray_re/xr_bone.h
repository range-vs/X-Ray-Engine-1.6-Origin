...
typedef std::vector< xr_bone* > xr_bone_vec; typedef std::vector< xr_bone* >::iterator xr_bone_vec_it; typedef std::vector< xr_bone* >::const_iterator xr_bone_vec_cit;
...
typedef std::vector< xr_partition* > xr_partition_vec; typedef std::vector< xr_partition* >::iterator xr_partition_vec_it; typedef std::vector< xr_partition* >::const_iterator xr_partition_vec_cit;

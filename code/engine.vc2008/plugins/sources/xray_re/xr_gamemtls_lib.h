...
typedef std::vector< xr_gamemtl* > xr_gamemtl_vec; typedef std::vector< xr_gamemtl* >::iterator xr_gamemtl_vec_it; typedef std::vector< xr_gamemtl* >::const_iterator xr_gamemtl_vec_cit;
...
typedef std::vector< xr_gamemtlpair* > xr_gamemtlpair_vec; typedef std::vector< xr_gamemtlpair* >::iterator xr_gamemtlpair_vec_it; typedef std::vector< xr_gamemtlpair* >::const_iterator xr_gamemtlpair_vec_cit;

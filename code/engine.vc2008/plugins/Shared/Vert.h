...
typedef xr_vector< SVertexData > VDVec; typedef VDVec::iterator VDIt;
...
typedef xr_vector< CVertexDef* > VertexDefVec; typedef VertexDefVec::iterator VertexDefIt;
...
typedef xr_vector< st_VERT* > ExpVertVec; typedef ExpVertVec::iterator ExpVertIt;

...
typedef xr_vector< SmdBone* > SmdBoneVec; typedef SmdBoneVec::iterator SmdBoneIt;
typedef xr_vector< SmdTriangle* > SmdTriVec; typedef SmdTriVec::iterator SmdTriIt;
typedef xr_vector< SmdVertex* > SmdVertVec; typedef SmdVertVec::iterator SmdVertIt;

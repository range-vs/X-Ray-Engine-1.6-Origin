...
void CInput::MouseUpdate( )
{
	...
	for (u32 i = 0; i < dwElements; i++){
		...
		{
			offs[0]	+= od[i].dwData; timeStamp[0] = od[i].dwTimeStamp;
		}
		else if( od[i].dwOfs == DIMOFS_Y)
		{
			offs[1]	+= od[i].dwData; timeStamp[1] = od[i].dwTimeStamp;
		}
		else if ( od[i].dwOfs == DIMOFS_Z)
		{
			offs[2]	+= od[i].dwData; timeStamp[2] = od[i].dwTimeStamp;
		}
		else if (od[i].dwOfs == DIMOFS_BUTTON0)
		{
			if ( od[i].dwData & 0x80 )	
		...
		else if (od[i].dwOfs == DIMOFS_BUTTON3)
		{
			if ( od[i].dwData & 0x80 )
		...
		else if (od[i].dwOfs == DIMOFS_BUTTON4)
		{
			if ( od[i].dwData & 0x80 )	
		...
		else if (od[i].dwOfs == DIMOFS_BUTTON5)
		{
			if ( od[i].dwData & 0x80 )	
		...
		else if (od[i].dwOfs == DIMOFS_BUTTON6)
		{
			if ( od[i].dwData & 0x80 )	
		...
		else if (od[i].dwOfs == DIMOFS_BUTTON7)
		{
			if ( od[i].dwData & 0x80 )	

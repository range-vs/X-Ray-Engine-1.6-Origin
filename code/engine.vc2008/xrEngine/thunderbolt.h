...
{
	typedef xr_vector< SThunderboltDesc* > DescVec; typedef DescVec::iterator DescIt;
	DescVec			  			palette;
	shared_str					section;
public:
...
protected:
	typedef xr_vector< SThunderboltCollection* > CollectionVec; typedef CollectionVec::iterator CollectionVecIt;

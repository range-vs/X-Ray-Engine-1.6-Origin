...
public:
    ...
    typedef xr_vector< SFlare > FlareVec; typedef FlareVec::iterator FlareIt;
    FlareVec			m_Flares;
...
typedef xr_vector< CLensFlareDescriptor* > LensFlareDescVec; typedef LensFlareDescVec::iterator LensFlareDescIt;

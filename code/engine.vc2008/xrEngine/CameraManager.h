...
typedef xr_list< CEffectorCam* > EffectorCamVec; typedef EffectorCamVec::iterator EffectorCamIt;
typedef xr_vector< CEffectorPP* > EffectorPPVec; typedef EffectorPPVec::iterator EffectorPPIt;

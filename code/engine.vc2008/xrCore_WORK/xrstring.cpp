...
str_value*	str_container::dock		(str_c value)
{
	...
	VERIFY	(sizeof(str_value)+s_len_with_zero < 4096); //range fix
	...
	if (0==result 
		...
		result					= (str_value*)Memory.mem_alloc(sizeof(str_value)
#ifdef DEBUG_MEMORY_NAME
			, "storage: sstring"
#endif // DEBUG_MEMORY_NAME
			);  // range fix
		result->value = (char*)Memory.mem_alloc(s_len_with_zero
#ifdef DEBUG_MEMORY_NAME
			, "storage: sstring value"
#endif // DEBUG_MEMORY_NAME

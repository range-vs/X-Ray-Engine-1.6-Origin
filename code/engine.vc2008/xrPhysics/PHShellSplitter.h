...
typedef xr_map< u16,CODEGeom* > GEOM_MAP; typedef GEOM_MAP::iterator GEOM_MAP_I;
...
typedef xr_vector< CPHShellSplitter > SPLITTER_STORAGE; typedef SPLITTER_STORAGE::iterator SPLITTER_I;

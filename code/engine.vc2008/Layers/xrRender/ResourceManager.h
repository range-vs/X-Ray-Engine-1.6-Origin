...
public:
	typedef xr_map<  const char*,IBlender*, str_pred > map_Blender; typedef map_Blender::iterator map_BlenderIt;
	typedef xr_map<  const char*,CTexture*, str_pred > map_Texture; typedef map_Texture::iterator map_TextureIt;
	typedef xr_map<  const char*,CMatrix*, str_pred > map_Matrix; typedef map_Matrix::iterator map_MatrixIt;
	typedef xr_map<  const char*,CConstant*, str_pred > map_Constant; typedef map_Constant::iterator map_ConstantIt;
	typedef xr_map<  const char*,CRT*, str_pred > map_RT; typedef map_RT::iterator map_RTIt;
	//	DX10 cut DEFINE_MAP_PRED(const char*,CRTC*,			map_RTC,		map_RTCIt,			str_pred);
	typedef xr_map<  const char*,SVS*, str_pred > map_VS; typedef map_VS::iterator map_VSIt;
#if defined(USE_DX10) || defined(USE_DX11)
	typedef xr_map<  const char*,SGS*, str_pred > map_GS; typedef map_GS::iterator map_GSIt;
#endif	//	USE_DX10
#ifdef USE_DX11
	typedef xr_map<  const char*,SHS*, str_pred > map_HS; typedef map_HS::iterator map_HSIt;
	typedef xr_map<  const char*,SDS*, str_pred > map_DS; typedef map_DS::iterator map_DSIt;
	typedef xr_map<  const char*,SCS*, str_pred > map_CS; typedef map_CS::iterator map_CSIt;
#endif

	typedef xr_map<  const char*,SPS*, str_pred > map_PS; typedef map_PS::iterator map_PSIt;
	typedef xr_map<  const char*,texture_detail, str_pred > map_TD; typedef map_TD::iterator map_TDIt;
private:
	// data

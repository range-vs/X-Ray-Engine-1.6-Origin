...
class CTextureDescrMngr
{
	...
	typedef xr_map< shared_str,texture_desc > map_TD; typedef map_TD::iterator map_TDIt;
	typedef xr_map< shared_str,cl_dt_scaler* > map_CS; typedef map_CS::iterator map_CSIt;

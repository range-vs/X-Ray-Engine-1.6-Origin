...
namespace PS
{
	...
	public:
		...
		typedef xr_vector< SEffect* > EffectVec; typedef EffectVec::iterator EffectIt;
		EffectVec			m_Effects;
#ifdef _EDITOR
// change Equal if variables changed 
	...
	public:
    	typedef xr_vector< dxRender_Visual* > VisualVec; typedef VisualVec::iterator VisualVecIt;
    	struct SItem		{
        ...
        typedef xr_vector< SItem > SItemVec; typedef SItemVec::iterator SItemVecIt;
		SItemVec			items;
	public:
		enum{
			flRT_Playing		= (1<<0),

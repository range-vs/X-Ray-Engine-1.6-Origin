...
public:
	...
	typedef xr_vector< static_wallmark* > StaticWMVec; typedef StaticWMVec::iterator StaticWMVecIt;
	typedef xr_vector< wm_slot* > WMSlotVec; typedef WMSlotVec::iterator WMSlotVecIt;
private:
